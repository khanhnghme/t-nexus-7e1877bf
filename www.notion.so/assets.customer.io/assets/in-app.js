(() => {
    var p = class {
        ...
        _loadGist() {
            ...
            let c = n.getAttribute("data-site-id");
            if (!c) {
        ...
        _init(n) {
            ...
            let c = this.cio._findCustomer();
            c != "" ? window.Gist.setUserToken(c) : window.Gist.clearUserToken();
            let s = (i, e, t, o) => {
                let d = {
                    type: "in_app",
                    payload: {
            ...
            window.Gist.events.on("messageShown", i => {
                var o, d, a, r;
                let e = (d = (o = i == null ? void 0 : i.properties) == null ? void 0 : o.gist) == null ? void 0 : d.campaignId,
                    t = i == null ? void 0 : i.instanceId;
                typeof e != "undefined" && e != "" && s(i.properties.gist.campaignId, "opened", "", ""), this.cio._eventBus.emit("in-app:message-opened", {
                    messageId: i.messageId,
                    deliveryId: (r = (a = i.properties) == null ? void 0 : a.gist) == null ? void 0 : r.campaignId,
                    message: {
                        dismiss: function() {
                ...
                var o, d, a, r, l, g;
                let e = (a = (d = (o = i == null ? void 0 : i.message) == null ? void 0 : o.properties) == null ? void 0 : d.gist) == null ? void 0 : a.campaignId,
                    t = (r = i == null ? void 0 : i.message) == null ? void 0 : r.instanceId;
                i.action != "gist://close" && typeof e != "undefined" && e != "" && s(i.message.properties.gist.campaignId, "clicked", i.name, i.action), this.cio._eventBus.emit("in-app:message-action", {
                    ...
                    deliveryId: (g = (l = i.message.properties) == null ? void 0 : l.gist) == null ? void 0 : g.campaignId,
                    action: i.action,
                    name: i.name,
                    actionName: i.name,
            ...
            }), window.Gist.events.on("eventDispatched", i => {
                var e;
                if (i.name == "analytics:track") {
                    let t = (e = i.payload) == null ? void 0 : e.event;
                    if (typeof t == "undefined" || t == "") return;
                    this.cio.track(t, i.payload.properties, null)
                }
            }), this._initialized = !0
        }
    };
    var I = window._cio;
    I && I.notifyPluginLoaded(p);
})();