    ...
    [22130], {
        522130: (e, t, r) => {
            r.r(t), r.d(t, {
                ...
                __domTree: () => aU,
                __parse: () => aP,
                __renderToDomTree: () => aF,
                __renderToHTMLTree: () => aV,
                __setFontMetrics: () => F,
                default: () => a_,
                render: () => aD,
                renderToString: () => aN,
            ...
            class i {
                constructor(e, t) {
                    ...
                    var r = "KaTeX parse error: " + e,
                        a = t && t.loc;
                    if (a && a.start <= a.end) {
                        var n, s, o = a.lexer.input;
                        n = a.start, s = a.end, n === o.length ? r += " at end of input: " : r += " at position " + (n + 1) + ": ";
                        var l = o.slice(n, s).replace(/[^]/g, "$&̲");
                        r += (n > 15 ? "…" + o.slice(n - 15, n) : o.slice(0, n)) + l + (s + 15 < o.length ? o.slice(s, s + 15) + "…" : o.slice(s))
                    }
                    var h = Error(r);
                    return h.name = "ParseError", h.__proto__ = i.prototype, h.position = n, null != n && null != s && (h.length = s - n), h.rawMessage = e, h
                }
            }
            ...
            class y {
                ...
                reportNonstrict(e, t, r) {
                    ...
                    if ("function" == typeof a && (a = a(e, t, r)), a && "ignore" !== a) {
                        ...
                        "warn" === a ? "u" > typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + (t + " [") + e + "]") : "u" > typeof console && console.warn("LaTeX-incompatible input and strict mode is set to " + ("unrecognized '" + a + "': " + t + " [") + e + "]")
                    }
                }
                useStrictBehavior(e, t, r) {
                    ...
                    return !!a && "ignore" !== a && (!0 === a || "error" === a || ("warn" === a ? ("u" > typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + (t + " [") + e + "]"), !1) : ("u" > typeof console && console.warn("LaTeX-incompatible input and strict mode is set to " + ("unrecognized '" + a + "': " + t + " [") + e + "]"), !1)))
                }
                isTrusted(e) {
                    if (e.url && !e.protocol) {
                        var t = v(e.url);
            ...
            function V(e, t, r) {
                if (!N[t]) throw Error("Font metrics not found for font: " + t + ".");
                var a = e.charCodeAt(0),
                    n = N[t][a];
                if (!n && e[0] in L && (a = L[e[0]].charCodeAt(0), n = N[t][a]), !n && "text" === r && I(a) && (n = N[t][77]), n) return {
                    depth: n[0],
                    height: n[1],
                    italic: n[2],
                    skew: n[3],
            ...
            var G = {},
                ...
                _ = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
                Y = function(e, t) {
                    return t.size < 2 ? e : U[e - 1][t.size - 1]
                };
            class X {
                constructor(e) {
                    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || X.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = _[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0
                }
                extend(e) {
                    var t = {
                        style: this.style,
            ...
            var W = {
                ...
                $ = function(e) {
                    return "string" != typeof e && (e = e.unit), e in W || e in j || "ex" === e
                },
                Z = function(e, t) {
                    var r, a;
                ...
                ee = function(e) {
                    ...
                    for (var r in t.className = J(this.classes), this.style) this.style.hasOwnProperty(r) && (t.style[r] = this.style[r]);
                ...
                er = function(e) {
                    var t = "<" + e;
                    this.classes.length && (t += ' class="' + d(J(this.classes)) + '"');
                    var r = "";
                    for (var a in this.style) this.style.hasOwnProperty(a) && (r += g(a) + ":" + this.style[a] + ";");
                    for (var n in r && (t += ' style="' + d(r) + '"'), this.attributes)
                        if (this.attributes.hasOwnProperty(n)) {
                            if (et.test(n)) throw new i("Invalid attribute name '" + n + "'");
                            t += " " + n + '="' + d(this.attributes[n]) + '"'
                        }
                    t += ">";
            ...
            class ea {
                constructor(e, t, r, a) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, Q.call(this, e, r, a), this.children = t || []
                }
                setAttribute(e, t) {
                    this.attributes[e] = t
                }
            ...
            class en {
                constructor(e, t, r, a) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, Q.call(this, t, a), this.children = r || [], this.setAttribute("href", e)
                }
                setAttribute(e, t) {
                    this.attributes[e] = t
                }
            ...
            class ei {
                ...
                toMarkup() {
                    var e = '<img src="' + d(this.src) + '" alt="' + d(this.alt) + '"',
                        t = "";
                    for (var r in this.style) this.style.hasOwnProperty(r) && (t += g(r) + ":" + this.style[r] + ";");
                    return t && (e += ' style="' + d(t) + '"'), e += "'/>"
                }
            }
            var es = {
                î: "ı̂",
            ...
            class eo {
                ...
                toNode() {
                    var e = document.createTextNode(this.text),
                        t = null;
                    for (var r in this.italic > 0 && ((t = document.createElement("span")).style.marginRight = K(this.italic)), this.classes.length > 0 && ((t = t || document.createElement("span")).className = J(this.classes)), this.style) this.style.hasOwnProperty(r) && ((t = t || document.createElement("span")).style[r] = this.style[r]);
                    return t ? (t.appendChild(e), t) : e
                }
                toMarkup() {
                    var e = !1,
                        t = "<span";
                    this.classes.length && (e = !0, t += ' class="', t += d(J(this.classes)), t += '"');
                    var r = "";
                    for (var a in this.italic > 0 && (r += "margin-right:" + this.italic + "em;"), this.style) this.style.hasOwnProperty(a) && (r += g(a) + ":" + this.style[a] + ";");
                    r && (e = !0, t += ' style="' + d(r) + '"');
                    var n = d(this.text);
            ...
            class el {
                ...
                toMarkup() {
                    ...
                    for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + '="' + d(this.attributes[t]) + '"');
                    e += ">";
            ...
            class eh {
                ...
                toMarkup() {
                    return this.alternate ? '<path d="' + d(this.alternate) + '"/>' : '<path d="' + d(O[this.pathName]) + '"/>'
                }
            }
            class em {
                constructor(e) {
            ...
            eg(ev, eb, eT, "–", "--", !0), eg(ev, eb, eT, "–", "\\textendash"), eg(ev, eb, eT, "—", "---", !0), eg(ev, eb, eT, "—", "\\textemdash"), eg(ev, eb, eT, "‘", "`", !0), eg(ev, eb, eT, "‘", "\\textquoteleft"), eg(ev, eb, eT, "’", "'", !0), eg(ev, eb, eT, "’", "\\textquoteright"), eg(ev, eb, eT, "“", "``", !0), eg(ev, eb, eT, "“", "\\textquotedblleft"), eg(ev, eb, eT, "”", "''", !0), eg(ev, eb, eT, "”", "\\textquotedblright"), eg(ef, eb, eT, "°", "\\degree", !0), eg(ev, eb, eT, "°", "\\degree"), eg(ev, eb, eT, "°", "\\textdegree", !0), eg(ef, eb, eT, "£", "\\pounds"), eg(ef, eb, eT, "£", "\\mathsterling", !0), eg(ev, eb, eT, "£", "\\pounds"), eg(ev, eb, eT, "£", "\\textsterling", !0), eg(ef, "ams", eT, "✠", "\\maltese"), eg(ev, "ams", eT, "✠", "\\maltese");
            for (var eq = '0123456789/@."', eC = 0; eC < eq.length; eC++) {
                var eI = eq.charAt(eC);
                eg(ef, eb, eT, eI, eI)
            }
            for (var eH = '0123456789!@*()-=+";:?/.,', eR = 0; eR < eH.length; eR++) {
                var eO = eH.charAt(eR);
                eg(ev, eb, eT, eO, eO)
            }
            for (var eE = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", eD = 0; eD < eE.length; eD++) {
                var eN = eE.charAt(eD);
                eg(ef, eb, ek, eN, eN), eg(ev, eb, eT, eN, eN)
            }
            ...
            for (var eP = "", eL = 0; eL < eE.length; eL++) {
                var eF = eE.charAt(eL);
                eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56320 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56372 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56424 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56580 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56684 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56736 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56788 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56840 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56944 + eL)), eg(ev, eb, eT, eF, eP), eL < 26 && (eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56632 + eL)), eg(ev, eb, eT, eF, eP), eg(ef, eb, ek, eF, eP = String.fromCharCode(55349, 56476 + eL)), eg(ev, eb, eT, eF, eP))
            }
            eg(ef, eb, ek, "k", eP = String.fromCharCode(55349, 56668)), eg(ev, eb, eT, "k", eP);
            for (var eV = 0; eV < 10; eV++) {
                var eG = eV.toString();
                eg(ef, eb, ek, eG, eP = String.fromCharCode(55349, 57294 + eV)), eg(ev, eb, eT, eG, eP), eg(ef, eb, ek, eG, eP = String.fromCharCode(55349, 57314 + eV)), eg(ev, eb, eT, eG, eP), eg(ef, eb, ek, eG, eP = String.fromCharCode(55349, 57324 + eV)), eg(ev, eb, eT, eG, eP), eg(ef, eb, ek, eG, eP = String.fromCharCode(55349, 57334 + eV)), eg(ev, eb, eT, eG, eP)
            }
            for (var eU = "ÐÞþ", e_ = 0; e_ < eU.length; e_++) {
                var eY = eU.charAt(e_);
                eg(ef, eb, ek, eY, eY), eg(ev, eb, eT, eY, eY)
            }
            var eX = [
                ...
                eZ = function(e, t, r, a, n) {
                    ...
                    } else "u" > typeof console && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '") + r + "'"), i = new eo(e, 0, 0, 0, 0, 0, n);
                    if (a) {
                ...
                e8 = function(e, t, r) {
                    var a = eQ([e], [], t);
                    return a.height = Math.max(r || t.fontMetrics().defaultRuleThickness, t.minRuleThickness), a.style.borderBottomWidth = K(a.height), a.maxFontSize = 1, a
                },
                e2 = function(e, t, r, a) {
                ...
                te = function(e, t) {
                    ...
                    for (var m = [], c = n, u = n, p = n, d = 0; d < a.length; d++) {
                        ...
                        if ("kern" === g.type) p += g.size;
                            ...
                            v.style.top = K(-i - p - f.depth), g.marginLeft && (v.style.marginLeft = g.marginLeft), g.marginRight && (v.style.marginRight = g.marginRight), m.push(v), p += f.height + f.depth
                        }
                        c = Math.min(c, p), u = Math.max(u, p)
                    }
                    var b = eQ(["vlist"], m);
                    if (b.style.height = K(u), c < 0) {
                        var y = eQ([], []),
                            x = eQ(["vlist"], [y]);
                        x.style.height = K(-c);
                ...
                tt = function(e, t, r) {
                    var a = e.mode,
                        ...
                        l = "",
                        h = "";
                    if (55349 === n.charCodeAt(0) && ([l, h] = ej(n, a)), l.length > 0) return eZ(n, l, a, t, i.concat(h));
                    if (o) {
                        if ("boldsymbol" === o) {
                            var m, c, u = "textord" !== r && e$(n, "Math-BoldItalic", a).metrics ? {
                            ...
                            m = u.fontName, c = [u.fontClass]
                        } else s ? (m = e6[o].fontName, c = [o]) : (m = e5(o, t.fontWeight, t.fontShape), c = [o, t.fontWeight, t.fontShape]);
                        if (e$(n, m, a).metrics) return eZ(n, m, a, t, i.concat(c));
                        if (eB.hasOwnProperty(n) && "Typewriter" === m.slice(0, 10)) {
                            for (var p = [], d = 0; d < n.length; d++) p.push(eZ(n[d], m, a, t, i.concat(c)));
                            return e1(p)
                        }
                    }
                    ...
                    if ("textord" === r) {
                        ...
                        if ("ams" === g) return eZ(n, e5("amsrm", t.fontWeight, t.fontShape), a, t, i.concat("amsrm", t.fontWeight, t.fontShape));
                        if ("main" === g || !g) return eZ(n, e5("textrm", t.fontWeight, t.fontShape), a, t, i.concat(t.fontWeight, t.fontShape));
                ...
                ta = function(e, t) {
                    var [r, a, n] = e7[e], i = e0(["overlay"], [new el([new eh(r)], {
                        width: K(a),
                        height: K(n),
                        style: "width:" + K(a),
            ...
            var tg = function(e) {
                ...
                tw = function(e, t, r, a) {
                    ...
                    return tk(n, (e, t) => {
                        var r = t.classes[0],
                            a = e.classes[0];
                        "mbin" === r && tb.includes(a) ? t.classes[0] = "mord" : "mbin" === a && tv.includes(r) && (e.classes[0] = "mord")
                    }, {
                        node: m
                    }, c, u), tk(n, (e, t) => {
                        var r = tM(t),
                ...
                tk = function e(t, r, a, n, i) {
                    ...
                    for (var s = 0; s < t.length; s++) {
                        ...
                        h ? a.node = o : i && o.hasClass("newline") && (a.node = eQ(["leftmost"])), n = s, a.insertAfter = e => {
                            t.splice(n + 1, 0, e), s++
                        }
                    }
                    n && t.pop()
                ...
                tM = function(e, t) {
                    return e ? (t && (e = tS(e, t)), tx[e.classes[0]] || null) : null
                },
                tA = function(e, t) {
            ...
            function tB(e, t) {
                var r = eQ(["base"], e, t),
                    a = eQ(["strut"]);
                return a.style.height = K(r.height + r.depth), r.depth && (a.style.verticalAlign = K(-r.depth)), r.children.unshift(a), r
            }
            ...
            function tq(e, t) {
                ...
                if (m.setAttribute("aria-hidden", "true"), a) {
                    var c = a.children[0];
                    c.style.height = K(m.height + m.depth), m.depth && (c.style.verticalAlign = K(-m.depth))
                }
                return m
            }
            ...
            class tI {
                ...
                toNode() {
                    ...
                    for (var r = 0; r < this.children.length; r++)
                        if (this.children[r] instanceof tH && this.children[r + 1] instanceof tH) {
                            for (var a = this.children[r].toText() + this.children[++r].toText(); this.children[r + 1] instanceof tH;) a += this.children[++r].toText();
                            e.appendChild(new tH(a).toNode())
                ...
                toMarkup() {
                    ...
                    this.classes.length > 0 && (e += ' class ="' + d(J(this.classes)) + '"'), e += ">";
                    for (var r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
                    return e + ("</" + this.type + ">")
                }
                toText() {
            ...
            var tR = class {
                ...
                tO = function(e, t, r) {
                    return ed[t][e] && ed[t][e].replace && 55349 !== e.charCodeAt(0) && !(eB.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.slice(4, 6) || r.font && "tt" === r.font.slice(4, 6))) && (e = ed[t][e].replace), new tH(e)
                },
                tE = function(e) {
                    return 1 === e.length ? e[0] : new tI("mrow", e)
                },
                tD = function(e, t) {
                    ...
                    var n = e.text;
                    return ["\\imath", "\\jmath"].includes(n) ? null : (ed[a][n] && ed[a][n].replace && (n = ed[a][n].replace), V(n, e6[r].fontName, a)) ? e6[r].variant : null
                };
            ...
            function tN(e) {
                ...
                var r = e.children[0];
                return r instanceof tH && "," === r.text
            }
            var tP = function(e, t, r) {
                    if (1 === e.length) {
                        var a, n = tF(e[0], t);
                        return r && n instanceof tI && "mo" === n.type && (n.setAttribute("lspace", "0em"), n.setAttribute("rspace", "0em")), [n]
                    }
                    for (var i = [], s = 0; s < e.length; s++) {
                        var o = tF(e[s], t);
                        if (o instanceof tI && a instanceof tI) {
                            if ("mtext" === o.type && "mtext" === a.type && o.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
                                ...
                                a.children.push(...o.children);
                                continue
                            } else if (tN(o) && "mn" === a.type) {
                                a.children.push(...o.children);
                                continue
                            } else if ("mn" === o.type && tN(a)) o.children = [...a.children, ...o.children], i.pop();
                            else if (("msup" === o.type || "msub" === o.type) && o.children.length >= 1 && ("mn" === a.type || tN(a))) {
                                var l = o.children[0];
                                l instanceof tI && "mn" === l.type && (l.children = [...a.children, ...l.children], i.pop())
                            } else if ("mi" === a.type && 1 === a.children.length) {
                                var h = a.children[0];
                                if (h instanceof tH && "̸" === h.text && ("mo" === o.type || "mi" === o.type || "mn" === o.type)) {
                                    var m = o.children[0];
                                    m instanceof tH && m.text.length > 0 && (m.text = m.text.slice(0, 1) + "̸" + m.text.slice(1), i.pop())
                                }
                            }
                        }
                        i.push(o), a = o
                ...
                tF = function(e, t) {
                    if (!e) return new tI("mrow");
                    if (tu[e.type]) return tu[e.type](e, t);
                    throw new i("Got group of unknown type: '" + e.type + "'")
                };

            function tV(e, t, r, a, n) {
                var i, s = tP(e, r);
                i = 1 === s.length && s[0] instanceof tI && ["mrow", "mtable"].includes(s[0].type) ? s[0] : new tI("mrow", s);
                var o = new tI("annotation", [new tH(t)]);
                o.setAttribute("encoding", "application/x-tex");
                var l = new tI("semantics", [i, o]),
                    h = new tI("math", [l]);
                return h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), a && h.setAttribute("display", "block"), eQ([n ? "katex" : "katex-mathml"], [h])
            }
            var tG = function(e) {
                    return new X({
                ...
                t_ = function(e, t, r) {
                    var a, n = tG(r);
                    return "mathml" === r.output ? tV(e, t, n, r.displayMode, !0) : tU(a = "html" === r.output ? eQ(["katex"], [tq(e, n)]) : eQ(["katex"], [tV(e, t, n, r.displayMode, !1), tq(e, n)]), r)
                },
                tY = {
                    widehat: "^",
                    widecheck: "ˇ",
                ...
                tW = function(e, t, r, a, n) {
                    ...
                    return i.height = s, i.style.height = K(s), i
                },
                tj = function(e) {
                    var t = new tI("mo", [new tH(tY[e.replace(/^\\/, "")])]);
                ...
                t$ = function(e, t) {
                    var {
                        ...
                        else if (3 === b) m = ["brace-left", "brace-center", "brace-right"], c = ["xMinYMin", "xMidYMin", "xMaxYMin"];
                        else throw Error("Correct katexImagesData or update code here to support\n                    " + b + " children.");
                        for (var y = 0; y < b; y++) {
                            var x = new el([new eh(d[y])], {
                                    width: "400em",
                                    height: K(v),
                                    viewBox: "0 0 " + r + " " + f,
            ...
            var tQ = (e, t) => {
                    e && "supsub" === e.type ? (o = (l = tZ(e.base, "accent")).base, e.base = o, h = function(e) {
                        if (e instanceof ea) return e;
                        throw Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                    }(tT(e, t)), e.base = l) : o = (l = tZ(e, "accent")).base;
                    var r = tT(o, t.havingCrampedStyle()),
                        a = l.isShifty && f(o),
                        n = 0;
                    a && (n = ec(tT(c(o), t.havingCrampedStyle())).skew);
                    var i = "\\c" === l.label,
                    ...
                    if (l.isStretchy) p = te({
                        ...
                        "\\vec" === l.label ? (m = ta("vec", t), u = e7.vec[1]) : ((m = ec(m = tt({
                            mode: l.mode,
                            text: l.label
                        }, t, "textord"))).italic = 0, u = m.width, i && (s += m.depth));
                        var o, l, h, m, u, p = eQ(["accent-body"], [m]),
                    ...
                    var v = eQ(["mord", "accent"], [p], t);
                    return h ? (h.children[0] = v, h.height = Math.max(v.height, h.height), h.classes[0] = "mord", h) : v
                },
                t0 = (e, t) => {
                    var r = e.isStretchy ? tj(e.label) : new tI("mo", [tO(e.label, e.mode)]),
                        a = new tI("mover", [tF(e.base, t), r]);
                    return a.setAttribute("accent", "true"), a
                },
                t1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(e => "\\" + e).join("|"));
            tp({
                type: "accent",
                ...
                mathmlBuilder: (e, t) => {
                    var r = tj(e.label),
                        a = new tI("munder", [tF(e.base, t), r]);
                    return a.setAttribute("accentunder", "true"), a
                }
            });
            var t4 = e => {
                var t = new tI("mpadded", e ? [e] : []);
            ...
            function t6(e, t) {
                var r, a = tP(e.body, t);
                return "minner" === e.mclass ? r = new tI("mpadded", a) : "mord" === e.mclass ? e.isCharacterBox ? (r = a[0]).type = "mi" : r = new tI("mi", a) : (e.isCharacterBox ? (r = a[0]).type = "mo" : r = new tI("mo", a), "mbin" === e.mclass ? (r.attributes.lspace = "0.22em", r.attributes.rspace = "0.22em") : "mpunct" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0.17em") : "mopen" === e.mclass || "mclose" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0em") : "minner" === e.mclass && (r.attributes.lspace = "0.0556em", r.attributes.width = "+0.1111em")), r
            }
            tp({
                type: "xArrow",
                ...
                htmlBuilder(e, t) {
                    var r, a, n = t.style,
                        ...
                        s = e9(tT(e.body, i, t), t),
                        o = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                    s.classes.push(o + "-arrow-pad"), e.below && (i = t.havingStyle(n.sub()), (r = e9(tT(e.below, i, t), t)).classes.push(o + "-arrow-pad"));
                    var l = t$(e, t),
                    ...
                    return a.children[0].children[0].children[1].classes.push("svg-align"), eQ(["mrel", "x-arrow"], [a], t)
                },
                mathmlBuilder(e, t) {
                    var r, a = tj(e.label);
                    if (a.setAttribute("minsize", "x" === e.label.charAt(0) ? "1.75em" : "3.0em"), e.body) {
                        var n = t4(tF(e.body, t));
                        r = e.below ? new tI("munderover", [a, t4(tF(e.below, t)), n]) : new tI("mover", [a, n])
                    } else r = e.below ? new tI("munder", [a, t4(tF(e.below, t))]) : new tI("mover", [a, r = t4()]);
                    return r
                }
            }), tp({
                type: "mclass",
            ...
            tp({
                ...
                mathmlBuilder(e, t) {
                    var r = new tI("mstyle", tP(e.body, t));
            ...
            tp({
                ...
                htmlBuilder(e, t) {
                    var r = t.havingStyle(t.style.sup()),
                        a = e9(tT(e.label, r, t), t);
                    return a.classes.push("cd-label-" + e.side), a.style.bottom = K(.8 - a.depth), a.height = 0, a.depth = 0, a
                },
                mathmlBuilder(e, t) {
                    var r = new tI("mrow", [tF(e.label, t)]);
                    return (r = new tI("mpadded", [r])).setAttribute("width", "0"), "left" === e.side && r.setAttribute("lspace", "-1width"), r.setAttribute("voffset", "0.7em"), (r = new tI("mstyle", [r])).setAttribute("displaystyle", "false"), r.setAttribute("scriptlevel", "1"), r
                }
            }), tp({
                type: "cdlabelparent",
                names: ["\\\\cdparent"],
                ...
                htmlBuilder(e, t) {
                    var r = e9(tT(e.fragment, t), t);
                    return r.classes.push("cd-vert-arrow"), r
                },
                mathmlBuilder: (e, t) => new tI("mrow", [tF(e.fragment, t)])
            }), tp({
                type: "textord",
                names: ["\\@char"],
                props: {
                ...
                handler(e, t) {
                    for (var r, {
                            parser: a
                        } = e, n = tZ(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++) s += tZ(n[o], "textord").text;
                    var l = parseInt(s);
            ...
            var re = (e, t) => e1(tw(e.body, t.withColor(e.color), !1)),
                rt = (e, t) => {
                    var r = new tI("mstyle", tP(e.body, t.withColor(e.color)));
            ...
            tp({
                ...
                handler(e, t) {
                    var {
                        parser: r
                    } = e, a = tZ(t[0], "color-token").color, n = t[1];
                    return {
                        type: "color",
                        mode: r.mode,
                        color: a,
                ...
                handler(e, t, r) {
                    ...
                    return {
                        ...
                        mode: a.mode,
                        newLine: i,
                        size: n && tZ(n, "size").value
                    }
                },
                htmlBuilder(e, t) {
                    var r = eQ(["mspace"], [], t);
                    return e.newLine && (r.classes.push("newline"), e.size && (r.style.marginTop = K(Z(e.size, t)))), r
                },
                mathmlBuilder(e, t) {
                    var r = new tI("mspace");
                    return e.newLine && (r.setAttribute("linebreak", "newline"), e.size && r.setAttribute("height", K(Z(e.size, t)))), r
                }
            });
            var rr = {
                    "\\global": "\\global",
            ...
            tp({
                ...
                handler(e) {
                    ...
                    t.consumeSpaces();
                    var a = t.fetch();
                    if (rr[a.text]) return ("\\global" === r || "\\\\globallong" === r) && (a.text = rr[a.text]), tZ(t.parseFunction(), "internal");
                ...
                handler(e) {
                    ...
                    var i = ("=" === (t = r.gullet.popToken()).text && " " === (t = r.gullet.popToken()).text && (t = r.gullet.popToken()), t);
            ...
            var ri = function(e, t, r) {
                    var a = V(ed.math[e] && ed.math[e].replace || e, t, r);
                ...
                rl = function(e, t, r, a, n, i) {
                    var s = rs(eZ(e, "Main-Regular", n, a), t, a, i);
                    return r && ro(s, a, t), s
                },
                rh = function(e, t, r, a, n, i) {
                    var s = eZ(e, "Size" + t + "-Regular", n, a),
                        o = rs(eQ(["delimsizing", "size" + t], [s], a), B.TEXT, a, i);
                    return r && ro(o, a, B.TEXT), o
                },
                rm = function(e, t, r) {
                    return {
                        type: "elem",
                        elem: eQ(["delimsizinginner", "Size1-Regular" === t ? "delim-size1" : "delim-size4"], [eQ([], [eZ(e, t, r)])])
                    }
                },
                rc = function(e, t, r) {
                    var a = N["Size4-Regular"][e.charCodeAt(0)] ? N["Size4-Regular"][e.charCodeAt(0)][4] : N["Size1-Regular"][e.charCodeAt(0)][4],
                        n = e0([], [new el([new eh("inner", R(e, Math.round(1e3 * t)))], {
                            width: K(a),
                            height: K(t),
                            style: "width:" + K(a),
                ...
                rg = function(e, t, r, a, n, i) {
                    ...
                    s = l = h = e, o = null;
                    var u = "Size1-Regular";
                    "\\uparrow" === e ? l = h = "⏐" : "\\Uparrow" === e ? l = h = "‖" : "\\downarrow" === e ? s = l = "⏐" : "\\Downarrow" === e ? s = l = "‖" : "\\updownarrow" === e ? (s = "\\uparrow", l = "⏐", h = "\\downarrow") : "\\Updownarrow" === e ? (s = "\\Uparrow", l = "‖", h = "\\Downarrow") : rp.includes(e) ? (l = "∣", m = "vert", c = 333) : rd.includes(e) ? (l = "∥", m = "doublevert", c = 556) : "[" === e || "\\lbrack" === e ? (s = "⎡", l = "⎢", h = "⎣", u = "Size4-Regular", m = "lbrack", c = 667) : "]" === e || "\\rbrack" === e ? (s = "⎤", l = "⎥", h = "⎦", u = "Size4-Regular", m = "rbrack", c = 667) : "\\lfloor" === e || "⌊" === e ? (l = s = "⎢", h = "⎣", u = "Size4-Regular", m = "lfloor", c = 667) : "\\lceil" === e || "⌈" === e ? (s = "⎡", l = h = "⎢", u = "Size4-Regular", m = "lceil", c = 667) : "\\rfloor" === e || "⌋" === e ? (l = s = "⎥", h = "⎦", u = "Size4-Regular", m = "rfloor", c = 667) : "\\rceil" === e || "⌉" === e ? (s = "⎤", l = h = "⎥", u = "Size4-Regular", m = "rceil", c = 667) : "(" === e || "\\lparen" === e ? (s = "⎛", l = "⎜", h = "⎝", u = "Size4-Regular", m = "lparen", c = 875) : ")" === e || "\\rparen" === e ? (s = "⎞", l = "⎟", h = "⎠", u = "Size4-Regular", m = "rparen", c = 875) : "\\{" === e || "\\lbrace" === e ? (s = "⎧", o = "⎨", h = "⎩", l = "⎪", u = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (s = "⎫", o = "⎬", h = "⎭", l = "⎪", u = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (s = "⎧", h = "⎩", l = "⎪", u = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (s = "⎫", h = "⎭", l = "⎪", u = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (s = "⎧", h = "⎭", l = "⎪", u = "Size4-Regular") : ("\\rmoustache" === e || "⎱" === e) && (s = "⎫", h = "⎩", l = "⎪", u = "Size4-Regular");
                    var p = ri(s, u, n),
                        d = p.height + p.depth,
                        g = ri(l, u, n),
                        f = g.height + g.depth,
                    ...
                    var k = d + b + y,
                        z = Math.max(0, Math.ceil((t - k) / (x * f))),
                        S = k + z * x * f,
                    ...
                    var A = S / 2 - M,
                        T = [];
                    if (m.length > 0) {
                        var q = Math.round(1e3 * S),
                            C = E(m, Math.round(1e3 * (S - d - b))),
                            I = new eh(m, C),
                        ...
                        O.height = q / 1e3, O.style.width = H, O.style.height = R, T.push({
                            type: "elem",
                            elem: O
                        })
                    } else {
                        if (T.push(rm(h, u, n)), T.push(ru), null === o) T.push(rc(l, S - d - b + .016, a));
                        else {
                            var D = (S - d - b - y) / 2 + .016;
                            T.push(rc(l, D, a)), T.push(ru), T.push(rm(o, u, n)), T.push(ru), T.push(rc(l, D, a))
                        }
                        T.push(ru), T.push(rm(s, u, n))
                    }
                    var N = a.havingBaseStyle(B.TEXT);
                    return rs(eQ(["delimsizing", "mult"], [te({
                        positionType: "bottom",
                        positionData: A,
                        children: T
                    }, N)], N), B.TEXT, a, i)
                ...
                rv = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"],
                rb = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"],
                ry = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
                rx = [0, 1.2, 1.8, 2.4, 3],
                rw = [{
                    type: "small",
                ...
                rA = function(e, t, r, a, n, i) {
                    ...
                    var s = ry.includes(e) ? rw : rv.includes(e) ? rz : rk,
                        o = rM(e, t, s, a);
                    return "small" === o.type ? rl(e, o.style, r, a, n, i) : "large" === o.type ? rh(e, o.size, r, a, n, i) : rg(e, t, r, a, n, i)
                },
                rT = function(e, t) {
                    var r, a, n = t.havingBaseSizing(),
                        i = rM("\\surd", e * n.sizeMultiplier, rz, n),
                        s = n.sizeMultiplier,
                        o = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness),
                        l = 0,
                        h = 0,
                        m = 0;
                    return "small" === i.type ? (m = 1e3 + 1e3 * o + 80, e < 1 ? s = 1 : e < 1.4 && (s = .7), l = (1 + o + .08) / s, h = (1 + o) / s, (r = rf("sqrtMain", l, m, o, t)).style.minWidth = "0.853em", a = .833 / s) : "large" === i.type ? (m = 1080 * rx[i.size], h = (rx[i.size] + o) / s, l = (rx[i.size] + o + .08) / s, (r = rf("sqrtSize" + i.size, l, m, o, t)).style.minWidth = "1.02em", a = 1 / s) : (l = e + o + .08, h = e + o, (r = rf("sqrtTall", l, m = Math.floor(1e3 * e + o) + 80, o, t)).style.minWidth = "0.742em", a = 1.056), r.height = h, r.style.height = K(l), {
                        span: r,
                        advanceWidth: a,
                        ruleWidth: (t.fontMetrics().sqrtRuleThickness + o) * s
                    }
                },
                rB = function(e, t, r, a, n) {
                    if ("<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), rv.includes(e) || ry.includes(e)) return rh(e, t, !1, r, a, n);
                    if (rb.includes(e)) return rg(e, rx[t], !1, r, a, n);
                ...
                rq = function(e, t, r, a, n, i) {
                    var s = a.fontMetrics().axisHeight * a.sizeMultiplier,
                        ...
                        l = Math.max(t - s, r + s);
                    return rA(e, Math.max(l / 500 * 901, 2 * l - o), !0, a, n, i)
                },
                rC = {
                    "\\bigl": {
                        mclass: "mopen",
            ...
            function rH(e, t) {
                var r = tJ(e);
                if (r && rI.includes(r.text)) return r;
            ...
            tp({
                ...
                htmlBuilder: (e, t) => "." === e.delim ? eQ([e.mclass]) : rB(e.delim, e.size, t, e.mode, [e.mclass]),
                mathmlBuilder: e => {
                    var t = [];
                ...
                handler: (e, t) => {
                    ...
                    var i = tZ(a.parseFunction(), "leftright-right");
                    return {
                        type: "leftright",
                        mode: a.mode,
                        body: n,
                ...
                htmlBuilder: (e, t) => {
                    ...
                    if (i *= t.sizeMultiplier, s *= t.sizeMultiplier, r = "." === e.left ? tA(t, ["mopen"]) : rq(e.left, i, s, t, e.mode, ["mopen"]), n.unshift(r), o)
                        for (var h = 1; h < n.length; h++) {
                            var m = n[h].isMiddle;
                            m && (n[h] = rq(m.delim, i, s, m.options, e.mode, []))
                        }
                    if ("." === e.right) a = tA(t, ["mclose"]);
                    else {
                        var c = e.rightColor ? t.withColor(e.rightColor) : t;
                        a = rq(e.right, i, s, c, e.mode, ["mclose"])
                    }
                ...
                mathmlBuilder: (e, t) => {
                    ...
                    var r = tP(e.body, t);
                    if ("." !== e.left) {
                        var a = new tI("mo", [tO(e.left, e.mode)]);
                        a.setAttribute("fence", "true"), r.unshift(a)
                    }
                    if ("." !== e.right) {
                        var n = new tI("mo", [tO(e.right, e.mode)]);
                ...
                mathmlBuilder: (e, t) => {
                    var r = new tI("mo", ["\\vert" === e.delim || "|" === e.delim ? tO("|", "text") : tO(e.delim, e.mode)]);
                    return r.setAttribute("fence", "true"), r.setAttribute("lspace", "0.05em"), r.setAttribute("rspace", "0.05em"), r
                }
            });
            var rO = (e, t) => {
                    var r, a, n = e9(tT(e.body, t), t),
                        i = e.label.slice(1),
                        s = t.sizeMultiplier,
                        o = 0,
                        l = f(e.body);
                    if ("sout" === i)(r = eQ(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, o = -.5 * t.fontMetrics().xHeight;
                    else if ("phase" === i) {
                        var h = Z({
                                number: .6,
                                unit: "pt"
                        ...
                        n.style.paddingLeft = K(c / 2 + h);
                        var u = Math.floor(1e3 * c * s);
                        (r = e0(["hide-tail"], [new el([new eh("phase", "M400000 " + u + " H0 L" + u / 2 + " 0 l65 45 L145 " + (u - 80) + " H400000z")], {
                            width: "400em",
                            height: K(u / 1e3),
                            viewBox: "0 0 400000 " + u,
                            preserveAspectRatio: "xMinYMin slice"
                        })], t)).style.height = K(c), o = n.depth + h + m
                    } else {
                        /cancel/.test(i) ? l || n.classes.push("cancel-pad") : "angl" === i ? n.classes.push("anglpad") : n.classes.push("boxpad");
                        var p = 0,
                            d = 0,
                            g = 0;
                        /box/.test(i) ? (g = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), d = p = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : g)) : "angl" === i ? (p = 4 * (g = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), d = Math.max(0, .25 - n.depth)) : d = p = .2 * !!l, r = tW(n, i, p, d, t), /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid", r.style.borderWidth = K(g)) : "angl" === i && .049 !== g && (r.style.borderTopWidth = K(g), r.style.borderRightWidth = K(g)), o = n.depth + d, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
                    }
                    ...
                    }, t), (/cancel/.test(i) && (a.height = n.height, a.depth = n.depth), /cancel/.test(i) && !l) ? eQ(["mord", "cancel-lap"], [a], t) : eQ(["mord"], [a], t)
                },
                rE = (e, t) => {
                    var r = 0,
                        a = new tI(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [tF(e.body, t)]);
                    switch (e.label) {
                        case "\\cancel":
            ...
            tp({
                ...
                handler(e, t, r) {
                    var {
                        parser: a,
                        funcName: n
                    } = e, i = tZ(t[0], "color-token").color, s = t[1];
                    return {
                        type: "enclose",
                        mode: a.mode,
                        label: n,
                ...
                handler(e, t, r) {
                    var {
                        parser: a,
                        funcName: n
                    } = e, i = tZ(t[0], "color-token").color, s = tZ(t[1], "color-token").color, o = t[2];
                    return {
                        type: "enclose",
                        mode: a.mode,
                        label: n,
            ...
            function rU(e, t, r) {
                ...
                for (w(), y.push(rF(e));;) {
                    ...
                    if ("&" === S) {
                        ...
                        k(), 1 === f.length && "styling" === z.type && 0 === z.body[0].body.length && (v.length > 1 || !u) && v.pop(), y.length < v.length + 1 && y.push([]);
                        break
                    } else if ("\\\\" === S) {
                        e.consume();
                        var M = void 0;
                        " " !== e.gullet.future().text && (M = e.parseSizeGroup(!0)), b.push(M ? M.value : null), k(), y.push(rF(e)), f = [], v.push(f), w()
            ...
            var rY = function(e, t) {
                    var r, a, n, s, o = e.body.length,
                        ...
                        g = 5 * d;
                    e.colSeparationType && "small" === e.colSeparationType && (g = .2778 * (t.havingStyle(B.SCRIPT).sizeMultiplier / t.sizeMultiplier));
                    var f = "CD" === e.colSeparationType ? Z({
                            number: 3,
                            unit: "ex"
                        }, t) : 12 * d,
                        v = 3 * d,
                    ...
                    for (k(l[0]), r = 0; r < e.body.length; ++r) {
                        ...
                        var A = Array(z.length);
                        for (a = 0; a < z.length; ++a) {
                            var T = tT(z[a], t);
                            M < T.depth && (M = T.depth), S < T.height && (S = T.height), A[a] = T
                        }
                        var q = e.rowGaps[r],
                            C = 0;
                        q && (C = Z(q, t)) > 0 && (M < (C += x) && (M = C), C = 0), e.addJot && (M += v), A.height = S, A.depth = M, A.pos = w += S, w += M + C, m[r] = A, k(l[r + 1])
                    }
                    var I = w / 2 + t.fontMetrics().axisHeight,
                        H = e.cols || [],
                        R = [],
                        O = [];
                    if (e.tags && e.tags.some(e => e))
                        for (r = 0; r < o; ++r) {
                            var E = m[r],
                                ...
                                N = e.tags[r],
                                P = void 0;
                            (P = !0 === N ? eQ(["eqn-num"], [], t) : !1 === N ? eQ([], [], t) : eQ([], tw(N, t, !0), t)).depth = E.depth, P.height = E.height, O.push({
                                type: "elem",
                                elem: P,
                                shift: D
                            })
                        }
                    for (a = 0, s = 0; a < h || s < H.length; ++a, ++s) {
                        for (var L = H[s] || {}, F = !0;
                            "separator" === L.type;) {
                            if (F || ((n = eQ(["arraycolsep"], [])).style.width = K(t.fontMetrics().doubleRuleSep), R.push(n)), "|" === L.separator || ":" === L.separator) {
                                var V = "|" === L.separator ? "solid" : "dashed",
                                    G = eQ(["vertical-separator"], [], t);
                                G.style.height = K(w), G.style.borderRightWidth = K(u), G.style.borderRightStyle = V, G.style.margin = "0 " + K(-u / 2);
                                var U = w - I;
                                U && (G.style.verticalAlign = K(-U)), R.push(G)
                            } else throw new i("Invalid separator type: " + L.separator);
                            L = H[++s] || {}, F = !1
                        }
                        if (!(a >= h)) {
                            var _ = void 0;
                            (a > 0 || e.hskipBeforeAndAfter) && 0 !== (_ = p(L.pregap, g)) && ((n = eQ(["arraycolsep"], [])).style.width = K(_), R.push(n));
                            var Y = [];
                            for (r = 0; r < o; ++r) {
                                var X = m[r],
                                    W = X[a];
                                if (W) {
                                    var j = X.pos - I;
                                    W.depth = X.depth, W.height = X.height, Y.push({
                                        type: "elem",
                                        elem: W,
                                        shift: j
                                    })
                            ...
                            Y = te({
                                positionType: "individualShift",
                                children: Y
                            }, t), Y = eQ(["col-align-" + (L.align || "c")], [Y]), R.push(Y), (a < h - 1 || e.hskipBeforeAndAfter) && 0 !== (_ = p(L.postgap, g)) && ((n = eQ(["arraycolsep"], [])).style.width = K(_), R.push(n))
                        }
                    }
                    if (m = eQ(["mtable"], R), c.length > 0) {
                        for (var $ = e8("hline", t, u), J = e8("hdashline", t, u), Q = [{
                                type: "elem",
                                elem: m,
                                shift: 0
                            }]; c.length > 0;) {
                    ...
                    if (0 === O.length) return eQ(["mord"], [m], t);
                    var er = te({
                        positionType: "individualShift",
                        children: O
                    }, t);
                    return e1([m, er = eQ(["tag"], [er], t)])
                },
                rX = {
                    c: "center ",
                    l: "left ",
                ...
                rW = function(e, t) {
                    for (var r = [], a = new tI("mtd", [], ["mtr-glue"]), n = new tI("mtd", [], ["mml-eqn-num"]), i = 0; i < e.body.length; i++) {
                        for (var s = e.body[i], o = [], l = 0; l < s.length; l++) o.push(new tI("mtd", [tF(s[l], t)]));
                        e.tags && e.tags[i] && (o.unshift(a), o.push(a), e.leqno ? o.unshift(n) : o.push(n)), r.push(new tI("mtr", o))
                    }
                    var h = new tI("mtable", r),
                        m = .5 === e.arraystretch ? .1 : .16 + e.arraystretch - 1 + .09 * !!e.addJot;
                    h.setAttribute("rowspacing", K(m));
                    var c = "",
                        u = "";
                    if (e.cols && e.cols.length > 0) {
                        ...
                        for (var b = f; b < v; b++) "align" === p[b].type ? (u += rX[p[b].align], g && (d += "none "), g = !0) : "separator" === p[b].type && g && (d += "|" === p[b].separator ? "solid " : "dashed ", g = !1);
                    ...
                    var k = "",
                        z = e.hLinesBeforeRow;
                    c += (z[0].length > 0 ? "left " : "") + (z[z.length - 1].length > 0 ? "right " : "");
                    for (var S = 1; S < z.length - 1; S++) k += 0 === z[S].length ? "none " : z[S][0] ? "dashed " : "solid ";
                    return /[sd]/.test(k) && h.setAttribute("rowlines", k.trim()), "" !== c && (h = new tI("menclose", [h])).setAttribute("notation", c.trim()), e.arraystretch && e.arraystretch < 1 && (h = new tI("mstyle", [h])).setAttribute("scriptlevel", "1"), h
                },
                rj = function(e, t) {
                    -1 === e.envName.indexOf("ed") && rV(e);
                    var r, a = [],
                    ...
                    if (t[0] && "ordgroup" === t[0].type) {
                        for (var m = "", c = 0; c < t[0].body.length; c++) m += tZ(t[0].body[c], "textord").text;
                        l = 2 * (r = Number(m))
                    }
                    var u = !l;
                    o.body.forEach(function(e) {
                        for (var t = 1; t < e.length; t += 2) {
                            var a = tZ(e[t], "styling");
                            tZ(a.body[0], "ordgroup").body.unshift(h)
                        }
            ...
            rN({
                ...
                handler(e, t) {
                    var r = (tJ(t[0]) ? [t[0]] : tZ(t[0], "ordgroup").body).map(function(e) {
                            var t = tK(e).text;
                    ...
                    return rU(e.parser, a, r_(e.envName))
                },
                htmlBuilder: rY,
                mathmlBuilder: rW
            }), rN({
                ...
                handler(e) {
                    ...
                    var s = rU(e.parser, a, r_(e.envName)),
                ...
                handler(e, t) {
                    ...
                    if ((a = rU(e.parser, a, "script")).body.length > 0 && a.body[0].length > 1) throw new i("{subarray} can contain only one column");
                    return a
                },
                htmlBuilder: rY,
                mathmlBuilder: rW
                ...
                handler(e) {
                    ["gather", "gather*"].includes(e.envName) && rV(e);
                    var t = {
                        cols: [{
                            type: "align",
                            align: "c"
                        ...
                        autoTag: rG(e.envName),
                        emptySingleRow: !0,
                        leqno: e.parser.settings.leqno
                    };
                    return rU(e.parser, t, "display")
                },
                htmlBuilder: rY,
                mathmlBuilder: rW
            }), rN({
                ...
                handler: e => (rV(e), function(e) {
                    ...
                    for (var a = [], n = [a], s = 0; s < t.length; s++) {
                        for (var o = t[s], l = t8(), h = 0; h < o.length; h++)
                            if (t2(o[h])) {
                                a.push(l);
                                var m = tK(o[h += 1]).text,
                                    c = [, , ];
                                if (c[0] = {
                                    ...
                                    for (var u = 0; u < 2; u++) {
                                        for (var p = !0, d = h + 1; d < o.length; d++) {
                                            ...
                                            if (t2(o[d])) throw new i("Missing a " + m + " character to complete a CD arrow.", o[d]);
                                            c[u].body.push(o[d])
                                        }
                                        if (p) throw new i("Missing a " + m + " character to complete a CD arrow.", o[h])
                ...
                handler(e, t) {
                    ...
                    for (var s = "", o = 0; o < n.body.length; ++o) s += tZ(n.body[o], "textord").text;
                    if ("\\begin" === a) {
                        if (!rD.hasOwnProperty(s)) throw new i("No such environment: " + s, n);
                        var l = rD[s],
                            {
                                args: h,
                                optArgs: m
                        ...
                        r.expect("\\end", !1);
                        var p = r.nextToken,
                            d = tZ(r.parseFunction(), "environment");
                        if (d.name !== s) throw new i("Mismatch: \\begin{" + s + "} matched by \\end{" + d.name + "}", p);
                        return u
                    }
                    return {
                        type: "environment",
            ...
            var rJ = (e, t) => {
                ...
                rQ = (e, t) => {
                    var r, a, n, i, s, o, l, h, m, c, u, p = rJ(e.size, t.style),
                        d = p.fracNum(),
                        g = p.fracDen();
                    r = t.havingStyle(d);
                    ...
                    return r = t.havingStyle(p), h.height *= r.sizeMultiplier / t.sizeMultiplier, h.depth *= r.sizeMultiplier / t.sizeMultiplier, m = p.size === B.DISPLAY.size ? t.fontMetrics().delim1 : p.size === B.SCRIPTSCRIPT.size ? t.havingStyle(B.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, c = null == e.leftDelim ? tA(t, ["mopen"]) : rA(e.leftDelim, m, !0, t.havingStyle(p), e.mode, ["mopen"]), u = e.continued ? eQ([]) : null == e.rightDelim ? tA(t, ["mclose"]) : rA(e.rightDelim, m, !0, t.havingStyle(p), e.mode, ["mclose"]), eQ(["mord"].concat(r.sizingClasses(t)), [c, eQ(["mfrac"], [h]), u], t)
                },
                r0 = (e, t) => {
                    var r = new tI("mfrac", [tF(e.numer, t), tF(e.denom, t)]);
                    if (e.hasBarLine) {
                        if (e.barSize) {
                            var a = Z(e.barSize, t);
                    ...
                    if (null != e.leftDelim || null != e.rightDelim) {
                        var s = [];
                        if (null != e.leftDelim) {
                            var o = new tI("mo", [new tH(e.leftDelim.replace("\\", ""))]);
                            o.setAttribute("fence", "true"), s.push(o)
                        }
                        if (s.push(r), null != e.rightDelim) {
                            var l = new tI("mo", [new tH(e.rightDelim.replace("\\", ""))]);
            ...
            var r1 = ["display", "text", "script", "scriptscript"],
                r4 = function(e) {
                    var t = null;
            ...
            tp({
                ...
                handler(e, t) {
                    var r, {
                        ...
                        i = t[5],
                        s = tg(t[0]),
                        o = "atom" === s.type && "open" === s.family ? r4(s.text) : null,
                        l = tg(t[1]),
                        h = "atom" === l.type && "close" === l.family ? r4(l.text) : null,
                        m = tZ(t[2], "size"),
                        c = null;
                    r = !!m.isBlank || (c = m.value).number > 0;
                    var u = "auto",
                        p = t[3];
                    return "ordgroup" === p.type ? p.body.length > 0 && (u = r1[Number(tZ(p.body[0], "textord").text)]) : u = r1[Number((p = tZ(p, "textord")).text)], {
                        type: "genfrac",
                        mode: a.mode,
                        numer: n,
                        denom: i,
                ...
                handler: (e, t) => {
                    var {
                        parser: r,
                        funcName: a
                    } = e, n = t[0], i = u(tZ(t[1], "infix").size), s = t[2], o = i.number > 0;
                    return {
                        type: "genfrac",
                        mode: r.mode,
                        numer: n,
            ...
            var r5 = (e, t) => {
                var r, a, n, i = t.style;
                "supsub" === e.type ? (r = e.sup ? tT(e.sup, t.havingStyle(i.sup()), t) : tT(e.sub, t.havingStyle(i.sub()), t), a = tZ(e.base, "horizBrace")) : a = tZ(e, "horizBrace");
            ...
            tp({
                ...
                mathmlBuilder: (e, t) => {
                    var r = tj(e.label);
                    return new tI(e.isOver ? "mover" : "munder", [tF(e.base, t), r])
                }
            }), tp({
                type: "href",
                names: ["\\href"],
                ...
                mathmlBuilder: (e, t) => {
                    var r = tL(e.body, t);
                    return r instanceof tI || (r = new tI("mrow", [r])), r.setAttribute("href", e.href), r
                }
            }), tp({
                type: "href",
                names: ["\\url"],
                ...
                mathmlBuilder: (e, t) => new tI("mrow", tP(e.body, t))
            }), tp({
                type: "html",
            ...
            var r6 = function(e) {
                ...
                if (!$(r)) throw new i("Invalid unit: '" + r.unit + "' in \\includegraphics.");
                return r
            };
            tp({
                ...
                handler: (e, t, r) => {
                    ...
                    if (r[0])
                        for (var h = tZ(r[0], "raw").string.split(","), m = 0; m < h.length; m++) {
                            var c = h[m].split("=");
                            if (2 === c.length) {
                                var u = c[1].trim();
                                switch (c[0].trim()) {
                ...
                htmlBuilder: (e, t) => {
                    var r = Z(e.height, t),
                        a = 0;
                    e.totalheight.number > 0 && (a = Z(e.totalheight, t) - r);
                    var n = 0;
                    e.width.number > 0 && (n = Z(e.width, t));
                    var i = {
                        height: K(r + a)
                    };
                ...
                mathmlBuilder: (e, t) => {
                    ...
                    var a = Z(e.height, t),
                        n = 0;
                    if (e.totalheight.number > 0 && (n = Z(e.totalheight, t) - a, r.setAttribute("valign", K(-n))), r.setAttribute("height", K(a + n)), e.width.number > 0) {
                        var i = Z(e.width, t);
                ...
                mathmlBuilder: (e, t) => new tR(Z(e.dimension, t))
            }), tp({
                type: "lap",
                ...
                htmlBuilder: (e, t) => {
                    "clap" === e.alignment ? (r = eQ([], [tT(e.body, t)]), r = eQ(["inner"], [r], t)) : r = eQ(["inner"], [tT(e.body, t)]);
                    var r, a = eQ(["fix"], []),
                        n = eQ([e.alignment], [r, a], t),
                        i = eQ(["strut"]);
                    return i.style.height = K(n.height + n.depth), n.depth && (i.style.verticalAlign = K(-n.depth)), n.children.unshift(i), n = eQ(["thinbox"], [n], t), eQ(["mord", "vbox"], [n], t)
                },
                mathmlBuilder: (e, t) => {
                    var r = new tI("mpadded", [tF(e.body, t)]);
                    if ("rlap" !== e.alignment) {
            ...
            tp({
                ...
                htmlBuilder: (e, t) => e1(tw(r7(e, t), t, !1)),
                mathmlBuilder: (e, t) => tL(r7(e, t), t)
            });
            var r3 = (e, t, r, a, n, i, s) => {
                    e = eQ([], [e]);
                    var o, l, h, m = r && f(r);
                    if (t) {
                    ...
                    if (r) {
                        var u = tT(r, a.havingStyle(n.sub()), a);
                        o = {
                            elem: u,
                ...
                r2 = (e, t) => {
                    var r, a, n, i, s = !1;
                    "supsub" === e.type ? (r = e.sup, a = e.sub, n = tZ(e.base, "op"), s = !0) : n = tZ(e, "op");
                    var o = t.style,
                        l = !1;
                    if (o.size === B.DISPLAY.size && n.symbol && !r8.includes(n.name) && (l = !0), n.symbol) {
                        var h = l ? "Size2-Regular" : "Size1-Regular",
                            m = "";
                        if (("\\oiint" === n.name || "\\oiiint" === n.name) && (m = n.name.slice(1), n.name = "oiint" === m ? "\\iint" : "\\iiint"), i = eZ(n.name, h, "math", t, ["mop", "op-symbol", l ? "large-op" : "small-op"]), m.length > 0) {
                            var c = i.italic;
                            i = te({
                                positionType: "individualShift",
                                children: [{
                        ...
                        var u = tw(n.body, t, !0);
                        1 === u.length && u[0] instanceof eo ? (i = u[0]).classes[0] = "mop" : i = eQ(["mop"], u, t)
                    } else {
                        for (var p = [], d = 1; d < n.name.length; d++) p.push(e3(n.name[d], n.mode, t));
                        i = eQ(["mop"], p, t)
                    }
                    var g = 0,
                        f = 0;
                    return ((i instanceof eo || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (g = (i.height - i.depth) / 2 - t.fontMetrics().axisHeight, f = i.italic), s) ? r3(i, r, a, t, o, f, g) : (g && (i.style.position = "relative", i.style.top = K(g)), i)
                },
                r9 = (e, t) => {
                    var r;
                    if (e.symbol) r = new tI("mo", [tO(e.name, e.mode)]), r8.includes(e.name) && r.setAttribute("largeop", "false");
                    else if (e.body) r = new tI("mo", tP(e.body, t));
                    else {
                        r = new tI("mi", [new tH(e.name.slice(1))]);
                        var a = new tI("mo", [tO("⁡", "text")]);
                        r = e.parentIsSupSub ? new tI("mrow", [r, a]) : tC([r, a])
                    }
                    return r
                },
                ae = {
            ...
            var ar = (e, t) => {
                var r, a, n, i, s = !1;
                if ("supsub" === e.type ? (r = e.sup, a = e.sub, n = tZ(e.base, "operatorname"), s = !0) : n = tZ(e, "operatorname"), n.body.length > 0) {
                ...
                return s ? r3(i, r, a, t, t.style, 0, 0) : i
            };
            ...
            tp({
                ...
                htmlBuilder: ar,
                mathmlBuilder: (e, t) => {
                    for (var r = tP(e.body, t.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
                        var i = r[n];
                        if (i instanceof tR);
                        else if (i instanceof tI) switch (i.type) {
                            case "mi":
                            case "mn":
                            case "ms":
                            case "mspace":
                            ...
                            case "mo":
                                var s = i.children[0];
                                1 === i.children.length && s instanceof tH ? s.text = s.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : a = !1;
                                break;
                            default:
                                a = !1
                        } else a = !1
                    }
                    a && (r = [new tH(r.map(e => e.toText()).join(""))]);
                    var o = new tI("mi", r);
                    o.setAttribute("mathvariant", "normal");
                    var l = new tI("mo", [tO("⁡", "text")]);
                    return e.parentIsSupSub ? new tI("mrow", [o, l]) : tC([o, l])
                }
            }), rP["\\operatorname"] = "\\@ifstar\\operatornamewithlimits\\operatorname@", td({
                type: "ordgroup",
                ...
                mathmlBuilder(e, t) {
                    var r = new tI("mo", [new tH("‾")]);
                    r.setAttribute("stretchy", "true");
                    var a = new tI("mover", [tF(e.body, t), r]);
                    return a.setAttribute("accent", "true"), a
                }
            }), tp({
                type: "phantom",
                ...
                mathmlBuilder: (e, t) => new tI("mphantom", tP(e.body, t))
            }), tp({
                type: "hphantom",
                names: ["\\hphantom"],
                props: {
                ...
                htmlBuilder: (e, t) => {
                    var r = eQ([], [tT(e.body, t.withPhantom())]);
                ...
                mathmlBuilder: (e, t) => {
                    var r = new tI("mphantom", tP(tf(e.body), t)),
                        a = new tI("mpadded", [r]);
                ...
                htmlBuilder: (e, t) => {
                    var r = eQ(["inner"], [tT(e.body, t.withPhantom())]),
                        a = eQ(["fix"], []);
                ...
                handler(e, t, r) {
                    var {
                        parser: a
                    } = e, n = r[0], i = tZ(t[0], "size"), s = tZ(t[1], "size");
                    return {
                        type: "rule",
                        mode: a.mode,
                        shift: n && tZ(n, "size").value,
                        width: i.value,
                        height: s.value
                    }
                },
                htmlBuilder(e, t) {
                    var r = eQ(["mord", "rule"], [], t),
                        a = Z(e.width, t),
                        n = Z(e.height, t),
                        i = e.shift ? Z(e.shift, t) : 0;
                    return r.style.borderRightWidth = K(a), r.style.borderTopWidth = K(n), r.style.bottom = K(i), r.width = a, r.height = n + i, r.depth = -i, r.maxFontSize = 1.125 * n * t.sizeMultiplier, r
                },
                mathmlBuilder(e, t) {
                    var r = Z(e.width, t),
                        a = Z(e.height, t),
                        n = e.shift ? Z(e.shift, t) : 0,
                        i = t.color && t.getColor() || "black",
                        s = new tI("mspace");
                    s.setAttribute("mathbackground", i), s.setAttribute("width", K(r)), s.setAttribute("height", K(a));
                    var o = new tI("mpadded", [s]);
                    return n >= 0 ? o.setAttribute("height", K(n)) : (o.setAttribute("height", K(n)), o.setAttribute("depth", K(-n))), o.setAttribute("voffset", K(n)), o
                }
            });
            ...
            tp({
                ...
                htmlBuilder: (e, t) => {
                    ...
                    return aa(e.body, r, t)
                },
                mathmlBuilder: (e, t) => {
                    var r = t.havingSize(e.size),
                        a = new tI("mstyle", tP(e.body, r));
                ...
                handler: (e, t, r) => {
                    var {
                        parser: a
                    } = e, n = !1, i = !1, s = r[0] && tZ(r[0], "ordgroup");
                    if (s)
                ...
                mathmlBuilder(e, t) {
                    ...
                    return a ? new tI("mroot", [tF(r, t), tF(a, t)]) : new tI("msqrt", [tF(r, t)])
                }
            });
            var ai = {
                display: B.DISPLAY,
            ...
            tp({
                ...
                htmlBuilder(e, t) {
                    ...
                    return aa(e.body, a, t)
                },
                mathmlBuilder(e, t) {
                    var r = ai[e.style],
                        a = t.havingStyle(r),
                        n = new tI("mstyle", tP(e.body, a)),
                        i = {
                            display: ["0", "true"],
                            text: ["0", "false"],
                            script: ["1", "false"],
            ...
            var as = function(e, t) {
                var r = e.base;
                if (!r) return null;
                if ("op" === r.type) return r.limits && (t.style.size === B.DISPLAY.size || r.alwaysHandleSupSub) ? r2 : null;
                if ("operatorname" === r.type) return r.alwaysHandleSupSub && (t.style.size === B.DISPLAY.size || r.limits) ? ar : null;
                if ("accent" === r.type) return f(r.base) ? tQ : null;
                if ("horizBrace" === r.type) return !e.sub === r.isOver ? r5 : null;
                else return null
            };
            td({
                type: "supsub",
                htmlBuilder(e, t) {
                    var r, a, n, i, s = as(e, t);
                    if (s) return s(e, t);
                    var {
                        base: o,
                        sup: l,
                        sub: h
                    } = e, m = tT(o, t), c = t.fontMetrics(), u = 0, p = 0, d = o && f(o);
                    if (l) {
                        var g = t.havingStyle(t.style.sup());
                        r = tT(l, g, t), d || (u = m.height - g.fontMetrics().supDrop * g.sizeMultiplier / t.sizeMultiplier)
                    }
                    if (h) {
                        var v = t.havingStyle(t.style.sub());
                        a = tT(h, v, t), d || (p = m.depth + v.fontMetrics().subDrop * v.sizeMultiplier / t.sizeMultiplier)
                    }
                    ...
                    if (a) {
                        ...
                        (m instanceof eo || w) && (x = K(-m.italic))
                    }
                    if (r && a) {
                        u = Math.max(u, n, r.depth + .25 * c.xHeight), p = Math.max(p, c.sub2);
                        var k = 4 * c.defaultRuleThickness;
                        if (u - r.depth - (a.height - p) < k) {
                            p = k - (u - r.depth) + a.height;
                            var z = .8 * c.xHeight - (u - r.depth);
                            z > 0 && (u += z, p -= z)
                        }
                        i = te({
                            positionType: "individualShift",
                        ...
                        positionType: "shift",
                        positionData: p = Math.max(p, c.sub1, a.height - .8 * c.xHeight),
                        children: [{
                            type: "elem",
                            elem: a,
                            marginLeft: x,
                    ...
                    return eQ([tM(m, "right") || "mord"], [m, eQ(["msupsub"], [i])], t)
                },
                mathmlBuilder(e, t) {
                    var r, a, n = !1;
                    ...
                    var i = [tF(e.base, t)];
                    if (e.sub && i.push(tF(e.sub, t)), e.sup && i.push(tF(e.sup, t)), n) a = r ? "mover" : "munder";
                    else if (e.sub)
                        if (e.sup) {
                            var s = e.base;
                            a = s && "op" === s.type && s.limits && t.style === B.DISPLAY || s && "operatorname" === s.type && s.alwaysHandleSupSub && (t.style === B.DISPLAY || s.limits) ? "munderover" : "msubsup"
                        } else {
                            var o = e.base;
                            a = o && "op" === o.type && o.limits && (t.style === B.DISPLAY || o.alwaysHandleSupSub) || o && "operatorname" === o.type && o.alwaysHandleSupSub && (o.limits || t.style === B.DISPLAY) ? "munder" : "msub"
                        }
                    else {
                        var l = e.base;
                ...
                type: "atom",
                htmlBuilder: (e, t) => e3(e.text, e.mode, t, ["m" + e.family]),
                mathmlBuilder(e, t) {
                    var r = new tI("mo", [tO(e.text, e.mode)]);
                    if ("bin" === e.family) {
                        var a = tD(e, t);
            ...
            td({
                ...
                mathmlBuilder(e, t) {
                    var r = new tI("mi", [tO(e.text, e.mode, t)]),
                        a = tD(e, t) || "italic";
                ...
                mathmlBuilder(e, t) {
                    var r, a = tO(e.text, e.mode, t),
                        n = tD(e, t) || "normal";
                    return n !== ao[(r = "text" === e.mode ? new tI("mtext", [a]) : /[0-9]/.test(e.text) ? new tI("mn", [a]) : "\\prime" === e.text ? new tI("mo", [a]) : new tI("mi", [a])).type] && r.setAttribute("mathvariant", n), r
                }
            });
            var al = {
                    "\\nobreak": "nobreak",
            ...
            td({
                type: "spacing",
                htmlBuilder(e, t) {
                    if (ah.hasOwnProperty(e.text)) {
                        var r = ah[e.text].className || "";
                        if ("text" !== e.mode) return eQ(["mspace", r], [e3(e.text, e.mode, t)], t);
                        var a = tt(e, t, "textord");
                        return a.classes.push(r), a
                    }
                    if (al.hasOwnProperty(e.text)) return eQ(["mspace", al[e.text]], [], t);
                    throw new i('Unknown type of space "' + e.text + '"')
                },
                mathmlBuilder(e, t) {
                    var r;
                    if (ah.hasOwnProperty(e.text)) r = new tI("mtext", [new tH(" ")]);
                    else if (al.hasOwnProperty(e.text)) return new tI("mspace");
            ...
            td({
                type: "tag",
                mathmlBuilder(e, t) {
                    var r = new tI("mtable", [new tI("mtr", [am(), new tI("mtd", [tL(e.body, t)]), am(), new tI("mtd", [tL(e.tag, t)])])]);
            ...
            var ac = {
                ...
                ad = (e, t) => {
                    var r = e.font;
                    return r ? ac[r] ? t.withTextFontFamily(ac[r]) : au[r] ? t.withTextFontWeight(au[r]) : "\\emph" === r ? "textit" === t.fontShape ? t.withTextFontShape("textup") : t.withTextFontShape("textit") : t.withTextFontShape(ap[r]) : t
                };
            tp({
                type: "text",
                ...
                mathmlBuilder(e, t) {
                    var r = new tI("mo", [new tH("‾")]);
                    r.setAttribute("stretchy", "true");
                    var a = new tI("munder", [tF(e.body, t), r]);
                    return a.setAttribute("accentunder", "true"), a
                }
            }), tp({
                type: "vcenter",
                ...
                mathmlBuilder: (e, t) => new tI("mpadded", [tF(e.body, t)], ["vcenter"])
            }), tp({
                type: "verb",
                names: ["\\verb"],
                props: {
                ...
                htmlBuilder(e, t) {
                    for (var r = ag(e), a = [], n = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
                        var s = r[i];
                        "~" === s && (s = "\\textasciitilde"), a.push(eZ(s, "Typewriter-Regular", e.mode, n, ["mord", "texttt"]))
                    }
                    return eQ(["mord", "text"].concat(n.sizingClasses(t)), tn(a), n)
                },
                mathmlBuilder(e, t) {
                    var r = new tI("mtext", [new tH(ag(e))]);
                    return r.setAttribute("mathvariant", "monospace"), r
                }
            });
            var ag = e => e.body.replace(/ /g, e.star ? "␣" : " "),
                af = "[ \r\n	]",
                av = "[̀-ͯ]",
                ab = RegExp(av + "+$"),
                ay = "(" + af + "+)|\\\\(\n|[ \r	]+\n?)[ \r	]*|([!-\\[\\]-‧‪-퟿豈-￿]" + av + "*|[\uD800-\uDBFF][\uDC00-\uDFFF]" + av + "*|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5|(\\\\[a-zA-Z@]+)" + af + "*|\\\\[^\uD800-\uDFFF])";
            class ax {
                constructor(e, t) {
                    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = RegExp(ay, "g"), this.catcodes = {
                        "%": 14,
                        "~": 13
                    }
                }
            ...
            }, rP["\\expandafter"] = function(e) {
                var t = e.popToken();
                return e.expandOnce(!0), {
                    tokens: [t],
                    numArgs: 0
                }
            }, rP["\\@firstoftwo"] = function(e) {
                return {
                    tokens: e.consumeArgs(2)[0],
                    numArgs: 0
                }
            }, rP["\\@secondoftwo"] = function(e) {
                return {
                    tokens: e.consumeArgs(2)[1],
                    numArgs: 0
                }
            }, rP["\\@ifnextchar"] = function(e) {
            ...
            }, rP["\\@ifstar"] = "\\@ifnextchar *{\\@firstoftwo{#1}}", rP["\\TextOrMath"] = function(e) {
            ...
            rP["\\dots"] = function(e) {
                ...
                return r in aS ? t = aS[r] : "\\not" === r.slice(0, 4) ? t = "\\dotsb" : r in ed.math && ["bin", "rel"].includes(ed.math[r].group) && (t = "\\dotsb"), t
            };
            var aM = {
                ")": !0,
                "]": !0,
            ...
            class aq {
                constructor(e, t, r) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new aw(rP, t.macros), this.mode = r, this.stack = []
                }
                feed(e) {
                ...
                scanArgument(e) {
                    ...
                    return this.pushToken(new n("EOF", r.loc)), this.pushTokens(i), new n("", a.range(t, r))
                }
                consumeSpaces() {
                    for (;;)
                ...
                consumeArg(e) {
                    ...
                    } while (0 !== s || a) return "{" === n.text && "}" === r[r.length - 1].text && (r.pop(), r.shift()), r.reverse(), {
                        tokens: r,
                        start: n,
                        end: t
                    }
                ...
                _getExpansion(e) {
                    ...
                    if ("string" == typeof a) {
                        ...
                        for (var s = new ax(a, this.settings), o = [], l = s.lex();
                ...
                isDefined(e) {
                    return this.macros.has(e) || tm.hasOwnProperty(e) || ed.math.hasOwnProperty(e) || ed.text.hasOwnProperty(e) || aB.hasOwnProperty(e)
                }
                isExpandable(e) {
                    var t = this.macros.get(e);
                    return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : tm.hasOwnProperty(e) && !tm[e].primitive
                }
            }
            var aC = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
                aI = Object.freeze({
                    "₊": "+",
                    "₋": "-",
                    "₌": "=",
            ...
            class aO {
                constructor(e, t) {
                    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new aq(e, t, this.mode), this.settings = t, this.leftrightDepth = 0
                }
                expect(e, t) {
                ...
                parseExpression(e, t) {
                    for (var r = [];;) {
                        ...
                        var a = this.fetch();
                        if (-1 !== aO.endOfExpression.indexOf(a.text) || t && a.text === t || e && tm[a.text] && tm[a.text].infix) break;
                ...
                handleSupSubscript(e) {
                    ...
                    do t = this.parseGroup(e); while ((null == t ? void 0 : t.type) === "internal") if (!t) throw new i("Expected group after '" + a + "'", r);
                    return t
                }
                ...
                parseAtom(e) {
                    ...
                    for (;;) {
                        ...
                        var s = this.fetch();
                        if ("\\limits" === s.text || "\\nolimits" === s.text) {
                            if (a && "op" === a.type) a.limits = "\\limits" === s.text, a.alwaysHandleSupSub = !0;
                            ...
                            var h = aC.test(s.text),
                                m = [];
                            for (m.push(new n(aI[s.text])), this.consume();;) {
                                var c = this.fetch().text;
                                if (!aI[c] || aC.test(c) !== h) break;
                                m.unshift(new n(aI[c])), this.consume()
                            }
                ...
                parseSizeGroup(e) {
                    ...
                    if (!$(n)) throw new i("Invalid unit: '" + n.unit + "'", t);
                    return {
                        type: "size",
                        mode: this.mode,
                        value: n,
                ...
                parseGroup(e, t) {
                    ...
                    } else if (null == (r = this.parseFunction(t, e) || this.parseSymbol()) && "\\" === s[0] && !aB.hasOwnProperty(s)) {
                ...
                parseSymbol() {
                    ...
                    aR.hasOwnProperty(t[0]) && !ed[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = aR[t[0]] + t.slice(1));
                    var s = ab.exec(t);
                    if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")), ed[this.mode][t]) {
                        ...
                        this.settings.strict && (I(t.charCodeAt(0)) ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '" (' + t.charCodeAt(0) + ")", e)), o = {
                            type: "textord",
                            mode: "text",
                            loc: a.range(e),
                            text: t
                    ...
                    if (this.consume(), s)
                        for (var m = 0; m < s[0].length; m++) {
                            var c = s[0][m];
                            if (!aH[c]) throw new i("Unknown accent ' " + c + "'", e);
                            var u = aH[c][this.mode] || aH[c].text;
                            if (!u) throw new i("Accent " + c + " unsupported in " + this.mode + " mode", e);
                            o = {
                                type: "accent",
                                mode: this.mode,
                                loc: a.range(e),
            ...
            "u" > typeof document && "CSS1Compat" !== document.compatMode && ("u" > typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), aD = function() {
                throw new i("KaTeX doesn't work in quirks mode.")
            });
            var aN = function(e, t) {
                    return aF(e, t).toMarkup()
                },
                aP = function(e, t) {
                    return aE(e, new y(t))
                },
                ...
                aV = function(e, t) {
                    var r, a, n = new y(t);
                    try {
                        return r = aE(e, n), a = n, tU(eQ(["katex"], [tq(r, tG(a))]), a)
                    } catch (t) {
                        return aL(t, e, n)
                    }
                },
