    ...
    [96527], {
            ...
            ! function(e, t) {
                ...
                function c(e, t) {
                    return function(e) {
                        ...
                        var n, r, o = e && ("u" > typeof Symbol && e[Symbol.iterator] || e["@@iterator"]);
                        if (null != o) {
                            var u = [],
                                c = !0,
                                i = !1;
                ...
                var m = (a = d.exports) && a.__esModule && Object.prototype.hasOwnProperty.call(a, "default") ? a.default : a,
                    h = function(e, n, r) {
                        var o = !!r,
                            u = t.useRef(r);
                    ...
                    b = function(e, t, n) {
                        return v(e) ? Object.keys(e).reduce(function(o, c) {
                            var i = !v(t) || !g(e[c], t[c]);
                ...
                var j = function(e, t) {
                    ...
                    O = function(e) {
                        ...
                        t.useEffect(function() {
                            ...
                            return "async" !== u.tag || a.stripe ? "sync" !== u.tag || a.stripe || t(u.stripe) : u.stripePromise.then(function(n) {
                                    n && e && t(n)
                                }),
                                function() {
                                    e = !1
                        ...
                        return t.useEffect(function() {
                            if (a.elements) {
                                var e = b(r, p, ["clientSecret", "fonts"]);
                                e && a.elements.update(e)
                            }
                        }, [r, p, a.elements]), t.useEffect(function() {
                            w(a.stripe)
                ...
                _.displayName = "CustomCheckoutContext";
                var I = function(e, t) {
                        if (!e) return null;
                        e.on, e.session;
                        var n = function(e, t) {
                    ...
                    B = function(e) {
                        ...
                        t.useEffect(function() {
                            if (p.customCheckoutSdk) {
                                !r.clientSecret || v(C) || g(r.clientSecret, C.clientSecret) || console.warn("Unsupported prop change: options.client_secret is not a mutable property.");
                                var e, t, n = null == C || null == (e = C.elementsOptions) ? void 0 : e.appearance,
                                    o = null == r || null == (t = r.elementsOptions) ? void 0 : t.appearance;
                                o && !g(o, n) && p.customCheckoutSdk.changeAppearance(o)
                            }
                        }, [r, C, p.customCheckoutSdk]), t.useEffect(function() {
                            w(p.stripe)
                        }, [p.stripe]);
                        var b = t.useMemo(function() {
                            return I(p.customCheckoutSdk, a)
                        }, [p.customCheckoutSdk, a]);
                        ...
                        var r = "".concat(e.charAt(0).toUpperCase() + e.slice(1), "Element"),
                            o = n ? function(e) {
                                ...
                                var o, u = n.id,
                                    ...
                                    T = t.useRef(null),
                                    _ = t.useRef(null);
                                h(R, "blur", l), h(R, "focus", p), h(R, "escape", m), h(R, "click", v), h(R, "loaderror", C), h(R, "loaderstart", g), h(R, "networkschange", E), h(R, "confirm", k), h(R, "cancel", S), h(R, "shippingaddresschange", w), h(R, "shippingratechange", P), h(R, "change", d), f && (o = "expressCheckout" === e ? f : function() {
                                    f(R)
                                }), h(R, "ready", o), t.useLayoutEffect(function() {
                                    if (null === T.current && null !== _.current && (O || x)) {
                                        var t = null;
                                        x ? t = x.createElement(e, s) : O && (t = O.create(e, s)), T.current = t, N(t), t && t.mount(_.current)
                                    }
                                }, [O, x, s]);
                                var I = y(s);
                                return t.useEffect(function() {
                                    if (T.current) {
                                        var e = b(s, I, ["paymentRequest"]);
                                        e && T.current.update(e)
                                    }
                                }, [s, I]), t.useLayoutEffect(function() {
                                    return function() {
                ...
                Y.displayName = "EmbeddedCheckoutProviderContext";
                var W = function() {
                    ...
                    Q = U("epsBank", L),
                    X = U("payment", L),
                    Z = U("expressCheckout", L),
                    ee = U("paymentRequestButton", L),
                    et = U("linkAuthentication", L),
                    en = U("address", L),
                    er = U("shippingAddress", L),
                    eo = U("paymentMethodMessaging", L),
                    eu = U("affirmMessage", L),
                    ec = U("afterpayClearpayMessage", L);
                e.AddressElement = en, e.AffirmMessageElement = eu, e.AfterpayClearpayMessageElement = ec, e.AuBankAccountElement = F, e.CardCvcElement = J, e.CardElement = D, e.CardExpiryElement = H, e.CardNumberElement = $, e.CustomCheckoutProvider = B, e.Elements = O, e.ElementsConsumer = A, e.EmbeddedCheckout = q, e.EmbeddedCheckoutProvider = function(e) {
                    var n = e.stripe,
                        r = e.options,
                        o = e.children,
                        u = t.useMemo(function() {
                    ...
                    t.useEffect(function() {
                        if (!a.current && !i.current) {
                            var e = function(e) {
                                a.current || i.current || (a.current = e, i.current = a.current.initEmbeddedCheckout(r).then(function(e) {
                                    p({
                                        embeddedCheckout: e
                                    })
                                }))
                            };
                            "async" === u.tag && !a.current && (r.clientSecret || r.fetchClientSecret) ? u.stripePromise.then(function(t) {
                                t && e(t)
                            }) : "sync" === u.tag && !a.current && (r.clientSecret || r.fetchClientSecret) && e(u.stripe)
                        }
                    }, [u, r, l, a]), t.useEffect(function() {
                        return function() {
                    ...
                    }, [d, r]), t.createElement(Y.Provider, {
                        value: l
                    }, o)
                }, e.EpsBankElement = Q, e.ExpressCheckoutElement = Z, e.FpxBankElement = V, e.IbanElement = z, e.IdealBankElement = G, e.LinkAuthenticationElement = et, e.P24BankElement = K, e.PaymentElement = X, e.PaymentMethodMessagingElement = eo, e.PaymentRequestButtonElement = ee, e.ShippingAddressElement = er, e.useCustomCheckout = function() {
                    T(t.useContext(N), "calls useCustomCheckout()");
                    var e = t.useContext(_);
        ...
        708009: (e, t) => {
            ...
            var r, o = "https://js.stripe.com/v3",
                ...
                m = function() {
                    ...
                    return (e = r, null !== l ? l : l = new Promise(function(t, n) {
                        ...
                        try {
                            var r = i();
                            r && e ? console.warn(c) : r || (r = a(e)), r.addEventListener("load", function() {
            ...
            m.setLoadParameters = function(e) {
                if (!(d && r && Object.keys(f(e)).reduce(function(t, n) {
                        var o;
                        return t && e[n] === (null == (o = r) ? void 0 : o[n])
                    }, !0))) {
                    if (d) throw Error("You cannot change load parameters after calling loadStripe");
                    r = f(e)
                }
            }, t.loadStripe = m
        }
